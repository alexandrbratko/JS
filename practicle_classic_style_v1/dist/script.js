...
/* harmony import */ var _modules_channgeModalState__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/channgeModalState */ "./src/js/modules/channgeModalState.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_channgeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
...
/***/ "./src/js/modules/channgeModalState.js":
/*!*********************************************!*\
  !*** ./src/js/modules/channgeModalState.js ***!
  \*********************************************/
...
var forms = function forms(state) {
  ...
  var closeModal = function closeModal(time) {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        window = document.querySelectorAll('[data-modal]'),
        scroll = calcScroll(); //триггер для клика
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.style.marginRight = "".concat(scroll, "px");
      });
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var header = document.querySelector(headerSelector),
      ...
      content = document.querySelectorAll(contentSelector); // скрываем контент
  ...
  hideTabContent();
  showTabContent(); // навешиваем обработчик событий и при делегировании перебираем табы
